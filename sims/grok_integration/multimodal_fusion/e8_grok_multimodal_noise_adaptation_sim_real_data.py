...
# Second cell: The sim code (optimized — 5000 epochs, extreme noise adaptation)
import torch
...
checkpoint_path = os.path.join(checkpoint_dir, "multimodal_noise_adaptation_checkpoint.pth")
...
for b in range(batch_size):
    ...
    # Extreme noise for adaptation test (0.5–1.0 amp)
