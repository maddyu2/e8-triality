...
# Sparse token proxies (mask fraction 0.3–0.7, token embedding coherence 0.85–1.0)
...
# Sectors: Mask fraction, Token coherence, Token symmetry, Prediction nulling
...
# ────────────────────────────────────────────────
# Training – full E8 model with triality
# ────────────────────────────────────────────────
model = E8TokenCyclePrior(use_triality=True).to(device)
...
# ────────────────────────────────────────────────
model_ablation = E8TokenCyclePrior(use_triality=False).to(device)
