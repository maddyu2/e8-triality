...
checkpoint_path = os.path.join(checkpoint_dir, "robotics_balance_checkpoint.pth")

# Synthetic robotics balance drift proxy (proprioceptive joint states + perturbations)
...
with torch.no_grad():
    ...
    plt.suptitle("E8 Triality Robotics Balance Drift Visualization")
    plt.tight_layout()
    plt.show()
