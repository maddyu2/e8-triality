...
checkpoint_path = os.path.join(checkpoint_dir, "long_context_token_chain_checkpoint.pth")

# Synthetic long context token chain proxy (real-like reasoning chains + drift/noise)
...
# High masking (70–90% — partial long context proxy)
