...
dim = 240
latent_dim = 8
seq_len = 1024  # proxy for long context (scale up to 10k–20k on better hardware)
noise_scale = 0.002
...
plt.tight_layout()
plt.savefig("grok5_long_context_ablation_precision_entropy.png", dpi=300, bbox_inches='tight')
plt.show()

print("Plots saved as grok5_long_context_ablation_precision_entropy.png")
