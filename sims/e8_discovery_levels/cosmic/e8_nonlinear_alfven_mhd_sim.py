...
# 2025 astrophysics proxies (Alfvén wave amplitude 0.1-1.0, density contrast 0.1-0.3, B ~10^{-5}-10^{-3} G in corona/wind)
# Vary wave amplitude / density contrast / magnetic field strength as input vectors
...
real_alfven_data = torch.cat([amplitude, density_contrast, magnetic_strength, nonlinear_sym], dim=-1).repeat(1, 1, dim // 4) * torch.randn(batch_size, seq_len, dim, device=device) * 0.005
...
# Sectors: Wave amplitude, Density contrast, Magnetic strength, Non-linear symmetry, Prediction nulling
