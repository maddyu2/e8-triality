...
# ARC fusion reactor proxies (2025–2030 targets: B_t ~9 T, I_p ~8 MA, β_N ~2.5–3.5, Q >10, confinement H98 ~1.2–1.5)
...
# Initial ARC state → precision target
states = real_data
...
plt.tight_layout()
plt.savefig("arc_fusion_reactor_ablation_precision_entropy.png", dpi=300, bbox_inches='tight')
plt.show()

print("Plots saved as arc_fusion_reactor_ablation_precision_entropy.png")
