...
# ARIES-CS stellarator proxies (QAS symmetry ~0.9–1.0, ITG growth γ ~0.1–0.5, neoclassical flux ~0.5–1.0)
...
neoc_flux = torch.linspace(0.5, 1.0, batch_size * seq_len, device=device).view(batch_size, seq_len, 1)
