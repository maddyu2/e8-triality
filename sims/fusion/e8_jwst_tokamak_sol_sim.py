...
# Vary flux/suppression as input vectors
...
real_jwst_data = torch.cat([flux, suppress, void_sym], dim=-1).repeat(1, 1, dim // 3) * torch.randn(batch_size, seq_len, dim, device=device) * 0.005
