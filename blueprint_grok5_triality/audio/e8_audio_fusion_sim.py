...
# Convert to embedding space (proxy for audio features)
real_data = audio_wave.unsqueeze(-1).repeat(1, 1, dim) * noise_scale  # expand to dim
...
plt.tight_layout()
plt.savefig("audio_fusion_ablation_precision_entropy.png", dpi=300, bbox_inches='tight')
plt.show()

print("Plots saved as audio_fusion_ablation_precision_entropy.png")
